...
export declare namespace ProductPhotoBackgroundGenerator {
    interface Options {
...
export class ProductPhotoBackgroundGenerator {
    constructor(protected readonly _options: ProductPhotoBackgroundGenerator.Options = {}) {}

    /**
     * @param {Gooey.ProductPhotoBackgroundGeneratorStatusRequest} request
     * @param {ProductPhotoBackgroundGenerator.RequestOptions} requestOptions - Request-specific configuration.
     *
