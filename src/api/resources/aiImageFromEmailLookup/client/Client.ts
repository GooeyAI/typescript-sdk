...
export declare namespace AiImageFromEmailLookup {
    interface Options {
...
export class AiImageFromEmailLookup {
    constructor(protected readonly _options: AiImageFromEmailLookup.Options = {}) {}

    /**
     * @param {Gooey.AiImageFromEmailLookupStatusRequest} request
     * @param {AiImageFromEmailLookup.RequestOptions} requestOptions - Request-specific configuration.
     *
