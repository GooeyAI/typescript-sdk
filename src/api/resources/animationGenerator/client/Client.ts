...
export declare namespace AnimationGenerator {
    interface Options {
...
export class AnimationGenerator {
    constructor(protected readonly _options: AnimationGenerator.Options = {}) {}

    /**
     * @param {Gooey.AnimationGeneratorStatusRequest} request
     * @param {AnimationGenerator.RequestOptions} requestOptions - Request-specific configuration.
     *
