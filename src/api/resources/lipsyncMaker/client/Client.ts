...
export declare namespace LipsyncMaker {
    interface Options {
...
export class LipsyncMaker {
    constructor(protected readonly _options: LipsyncMaker.Options = {}) {}

    /**
     * @param {Gooey.LipsyncMakerStatusRequest} request
     * @param {LipsyncMaker.RequestOptions} requestOptions - Request-specific configuration.
     *
