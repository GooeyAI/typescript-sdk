...
export declare namespace RelatedQnaMaker {
    interface Options {
...
export class RelatedQnaMaker {
    constructor(protected readonly _options: RelatedQnaMaker.Options = {}) {}

    /**
     * @param {Gooey.RelatedQnaMakerStatusRequest} request
     * @param {RelatedQnaMaker.RequestOptions} requestOptions - Request-specific configuration.
     *
