...
export declare namespace RenderImagesWithAi {
    interface Options {
...
export class RenderImagesWithAi {
    constructor(protected readonly _options: RenderImagesWithAi.Options = {}) {}

    /**
     * @param {Gooey.RenderImagesWithAiStatusRequest} request
     * @param {RenderImagesWithAi.RequestOptions} requestOptions - Request-specific configuration.
     *
