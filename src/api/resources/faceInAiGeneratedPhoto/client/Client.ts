...
export declare namespace FaceInAiGeneratedPhoto {
    interface Options {
...
export class FaceInAiGeneratedPhoto {
    constructor(protected readonly _options: FaceInAiGeneratedPhoto.Options = {}) {}

    /**
     * @param {Gooey.FaceInAiGeneratedPhotoStatusRequest} request
     * @param {FaceInAiGeneratedPhoto.RequestOptions} requestOptions - Request-specific configuration.
     *
