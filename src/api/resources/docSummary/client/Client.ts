...
export declare namespace DocSummary {
    interface Options {
...
export class DocSummary {
    constructor(protected readonly _options: DocSummary.Options = {}) {}

    /**
     * @param {Gooey.DocSummaryStatusRequest} request
     * @param {DocSummary.RequestOptions} requestOptions - Request-specific configuration.
     *
