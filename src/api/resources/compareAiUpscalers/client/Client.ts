...
export declare namespace CompareAiUpscalers {
    interface Options {
...
export class CompareAiUpscalers {
    constructor(protected readonly _options: CompareAiUpscalers.Options = {}) {}

    /**
     * @param {Gooey.CompareAiUpscalersStatusRequest} request
     * @param {CompareAiUpscalers.RequestOptions} requestOptions - Request-specific configuration.
     *
