...
export declare namespace DocExtract {
    interface Options {
...
export class DocExtract {
    constructor(protected readonly _options: DocExtract.Options = {}) {}

    /**
     * @param {Gooey.DocExtractStatusRequest} request
     * @param {DocExtract.RequestOptions} requestOptions - Request-specific configuration.
     *
