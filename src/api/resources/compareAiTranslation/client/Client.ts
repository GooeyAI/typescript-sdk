...
export declare namespace CompareAiTranslation {
    interface Options {
...
export class CompareAiTranslation {
    constructor(protected readonly _options: CompareAiTranslation.Options = {}) {}

    /**
     * @param {Gooey.CompareAiTranslationStatusRequest} request
     * @param {CompareAiTranslation.RequestOptions} requestOptions - Request-specific configuration.
     *
