...
export declare namespace Lipsync {
    interface Options {
...
export class Lipsync {
    constructor(protected readonly _options: Lipsync.Options = {}) {}

    /**
     * @param {Gooey.LipsyncStatusRequest} request
     * @param {Lipsync.RequestOptions} requestOptions - Request-specific configuration.
     *
