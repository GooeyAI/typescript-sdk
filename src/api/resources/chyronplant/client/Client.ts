...
export declare namespace Chyronplant {
    interface Options {
...
export class Chyronplant {
    constructor(protected readonly _options: Chyronplant.Options = {}) {}

    /**
     * @param {Gooey.ChyronplantStatusRequest} request
     * @param {Chyronplant.RequestOptions} requestOptions - Request-specific configuration.
     *
