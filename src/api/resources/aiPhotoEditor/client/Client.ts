...
export declare namespace AiPhotoEditor {
    interface Options {
...
export class AiPhotoEditor {
    constructor(protected readonly _options: AiPhotoEditor.Options = {}) {}

    /**
     * @param {Gooey.AiPhotoEditorStatusRequest} request
     * @param {AiPhotoEditor.RequestOptions} requestOptions - Request-specific configuration.
     *
