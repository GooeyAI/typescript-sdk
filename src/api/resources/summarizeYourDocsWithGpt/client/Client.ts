...
export class SummarizeYourDocsWithGpt {
    ...
    public async docSummary(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(await core.Supplier.get(this._options.environment), "v2/doc-summary/"),
            method: "POST",
            headers: {
    ...
    public async asyncDocSummary(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(await core.Supplier.get(this._options.environment), "v3/doc-summary/async/"),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
                "X-Fern-SDK-Name": "gooey",
    ...
    public async statusDocSummary(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(await core.Supplier.get(this._options.environment), "v3/doc-summary/status/"),
            method: "GET",
            headers: {
                "X-Fern-Language": "JavaScript",
                "X-Fern-SDK-Name": "gooey",
