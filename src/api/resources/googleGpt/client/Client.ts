...
export declare namespace GoogleGpt {
    interface Options {
...
export class GoogleGpt {
    constructor(protected readonly _options: GoogleGpt.Options = {}) {}

    /**
     * @param {Gooey.GoogleGptStatusRequest} request
     * @param {GoogleGpt.RequestOptions} requestOptions - Request-specific configuration.
     *
