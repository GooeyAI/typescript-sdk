...
export declare namespace RemoveImageBackgroundWithAi {
    interface Options {
...
export class RemoveImageBackgroundWithAi {
    constructor(protected readonly _options: RemoveImageBackgroundWithAi.Options = {}) {}

    /**
     * @param {Gooey.RemoveImageBackgroundWithAiStatusRequest} request
     * @param {RemoveImageBackgroundWithAi.RequestOptions} requestOptions - Request-specific configuration.
     *
