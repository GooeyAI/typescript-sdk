...
export declare namespace TextEmbedings {
    interface Options {
...
export class TextEmbedings {
    constructor(protected readonly _options: TextEmbedings.Options = {}) {}

    /**
     * @param {Gooey.TextEmbedingsStatusRequest} request
     * @param {TextEmbedings.RequestOptions} requestOptions - Request-specific configuration.
     *
