...
export declare namespace DocSearch {
    interface Options {
...
export class DocSearch {
    constructor(protected readonly _options: DocSearch.Options = {}) {}

    /**
     * @param {Gooey.DocSearchStatusRequest} request
     * @param {DocSearch.RequestOptions} requestOptions - Request-specific configuration.
     *
