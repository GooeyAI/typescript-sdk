...
export declare namespace EmailWriterWithProfileLookup {
    interface Options {
...
export class EmailWriterWithProfileLookup {
    constructor(protected readonly _options: EmailWriterWithProfileLookup.Options = {}) {}

    /**
     * @param {Gooey.EmailWriterWithProfileLookupStatusRequest} request
     * @param {EmailWriterWithProfileLookup.RequestOptions} requestOptions - Request-specific configuration.
     *
