...
export declare namespace CompareTextToSpeechEngines {
    interface Options {
...
export class CompareTextToSpeechEngines {
    constructor(protected readonly _options: CompareTextToSpeechEngines.Options = {}) {}

    /**
     * @param {Gooey.CompareTextToSpeechEnginesStatusRequest} request
     * @param {CompareTextToSpeechEngines.RequestOptions} requestOptions - Request-specific configuration.
     *
