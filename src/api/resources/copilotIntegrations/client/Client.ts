...
export class CopilotIntegrations {
    ...
    public async videoBotsStreamCreate(
        ...
        await _request.append("integration_id", request.integrationId);
        if (request.conversationId != null) {
            await _request.append("conversation_id", request.conversationId);
        }
        ...
        if (request.userMessageId != null) {
            await _request.append("user_message_id", request.userMessageId);
        }

        if (request.buttonPressed != null) {
            await _request.append("button_pressed", JSON.stringify(request.buttonPressed));
        }
        ...
        if (request.inputText != null) {
            await _request.append("input_text", request.inputText);
        }
