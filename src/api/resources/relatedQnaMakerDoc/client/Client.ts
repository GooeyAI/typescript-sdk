...
export declare namespace RelatedQnaMakerDoc {
    interface Options {
...
export class RelatedQnaMakerDoc {
    constructor(protected readonly _options: RelatedQnaMakerDoc.Options = {}) {}

    /**
     * @param {Gooey.RelatedQnaMakerDocStatusRequest} request
     * @param {RelatedQnaMakerDoc.RequestOptions} requestOptions - Request-specific configuration.
     *
