...
export declare namespace CompareLargeLanguageModels {
    interface Options {
...
export class CompareLargeLanguageModels {
    constructor(protected readonly _options: CompareLargeLanguageModels.Options = {}) {}

    /**
     * @param {Gooey.CompareLargeLanguageModelsStatusRequest} request
     * @param {CompareLargeLanguageModels.RequestOptions} requestOptions - Request-specific configuration.
     *
