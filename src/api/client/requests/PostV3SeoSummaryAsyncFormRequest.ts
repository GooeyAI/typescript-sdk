 ...
 *     }
 */
export interface PostV3SeoSummaryAsyncFormRequest {
    searchQuery: string;
    keywords: string;
    title: string;
    companyUrl: string;
    ...
    enableHtml?: boolean;
    selectedModel?: Gooey.PostV3SeoSummaryAsyncFormRequestSelectedModel;
    ...
    responseFormatType?: Gooey.PostV3SeoSummaryAsyncFormRequestResponseFormatType;
