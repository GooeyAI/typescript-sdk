...
export interface VideoBotsPageRequest {
    functions?: Gooey.VideoBotsPageRequestFunctionsItem[];
    ...
    messages?: Gooey.VideoBotsPageRequestMessagesItem[];
    botScript?: string;
    ...
    sadtalkerSettings?: Gooey.VideoBotsPageRequestSadtalkerSettings;
