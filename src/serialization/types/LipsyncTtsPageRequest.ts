...
import { LipsyncTtsPageRequestFunctionsItem } from "./LipsyncTtsPageRequestFunctionsItem";
...
import { LipsyncTtsPageRequestSadtalkerSettings } from "./LipsyncTtsPageRequestSadtalkerSettings";
...
> = core.serialization.object({
    functions: core.serialization.list(LipsyncTtsPageRequestFunctionsItem).optional(),
    ...
    sadtalkerSettings: core.serialization.property(
        "sadtalker_settings",
        LipsyncTtsPageRequestSadtalkerSettings.optional()
    ),
...
export declare namespace LipsyncTtsPageRequest {
    interface Raw {
        functions?: LipsyncTtsPageRequestFunctionsItem.Raw[] | null;
        ...
        sadtalker_settings?: LipsyncTtsPageRequestSadtalkerSettings.Raw | null;
