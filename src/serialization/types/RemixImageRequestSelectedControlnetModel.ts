...
import { RemixImageRequestSelectedControlnetModelItem } from "./RemixImageRequestSelectedControlnetModelItem";

export const RemixImageRequestSelectedControlnetModel: core.serialization.Schema<
    serializers.RemixImageRequestSelectedControlnetModel.Raw,
    Gooey.RemixImageRequestSelectedControlnetModel
> = core.serialization.undiscriminatedUnion([
    core.serialization.list(RemixImageRequestSelectedControlnetModelItem),
...
export declare namespace RemixImageRequestSelectedControlnetModel {
    type Raw =
        | RemixImageRequestSelectedControlnetModelItem.Raw[]
        | "sd_controlnet_canny"
        | "sd_controlnet_depth"
        | "sd_controlnet_hed"
        | "sd_controlnet_mlsd"
