...
import { CompareUpscalerPageRequestFunctionsItem } from "./CompareUpscalerPageRequestFunctionsItem";
...
> = core.serialization.object({
    functions: core.serialization.list(CompareUpscalerPageRequestFunctionsItem).optional(),
...
export declare namespace CompareUpscalerPageRequest {
    interface Raw {
        functions?: CompareUpscalerPageRequestFunctionsItem.Raw[] | null;
