...
export const BulkEvalPageStatusResponse: core.serialization.ObjectSchema<
    serializers.BulkEvalPageStatusResponse.Raw,
    Gooey.BulkEvalPageStatusResponse
> = core.serialization.object({
    ...
    output: BulkEvalPageOutput.optional(),
});

export declare namespace BulkEvalPageStatusResponse {
    interface Raw {
        run_id: string;
        web_url: string;
        created_at: string;
        ...
        detail: string;
        output?: BulkEvalPageOutput.Raw | null;
    }
}
