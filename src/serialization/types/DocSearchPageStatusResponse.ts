...
export const DocSearchPageStatusResponse: core.serialization.ObjectSchema<
    serializers.DocSearchPageStatusResponse.Raw,
    Gooey.DocSearchPageStatusResponse
> = core.serialization.object({
    ...
    output: DocSearchPageOutput.optional(),
});

export declare namespace DocSearchPageStatusResponse {
    interface Raw {
        run_id: string;
        web_url: string;
        created_at: string;
        ...
        detail: string;
        output?: DocSearchPageOutput.Raw | null;
    }
}
