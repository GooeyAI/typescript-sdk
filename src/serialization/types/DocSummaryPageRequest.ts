...
import { DocSummaryPageRequestFunctionsItem } from "./DocSummaryPageRequestFunctionsItem";
...
> = core.serialization.object({
    functions: core.serialization.list(DocSummaryPageRequestFunctionsItem).optional(),
...
export declare namespace DocSummaryPageRequest {
    interface Raw {
        functions?: DocSummaryPageRequestFunctionsItem.Raw[] | null;
