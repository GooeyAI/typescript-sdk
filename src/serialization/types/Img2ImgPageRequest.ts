...
import { Img2ImgPageRequestFunctionsItem } from "./Img2ImgPageRequestFunctionsItem";
...
> = core.serialization.object({
    functions: core.serialization.list(Img2ImgPageRequestFunctionsItem).optional(),
...
export declare namespace Img2ImgPageRequest {
    interface Raw {
        functions?: Img2ImgPageRequestFunctionsItem.Raw[] | null;
