...
import { ImageSegmentationPageRequestFunctionsItem } from "./ImageSegmentationPageRequestFunctionsItem";
...
> = core.serialization.object({
    functions: core.serialization.list(ImageSegmentationPageRequestFunctionsItem).optional(),
...
export declare namespace ImageSegmentationPageRequest {
    interface Raw {
        functions?: ImageSegmentationPageRequestFunctionsItem.Raw[] | null;
