...
import { LipsyncTtsPageOutput } from "./LipsyncTtsPageOutput";

export const LipsyncTtsPageStatusResponse: core.serialization.ObjectSchema<
    serializers.LipsyncTtsPageStatusResponse.Raw,
    Gooey.LipsyncTtsPageStatusResponse
> = core.serialization.object({
    ...
    output: LipsyncTtsPageOutput.optional(),
});

export declare namespace LipsyncTtsPageStatusResponse {
    interface Raw {
        run_id: string;
        web_url: string;
        created_at: string;
        ...
        detail: string;
        output?: LipsyncTtsPageOutput.Raw | null;
    }
}
