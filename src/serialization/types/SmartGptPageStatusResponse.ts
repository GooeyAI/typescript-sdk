...
export const SmartGptPageStatusResponse: core.serialization.ObjectSchema<
    serializers.SmartGptPageStatusResponse.Raw,
    Gooey.SmartGptPageStatusResponse
> = core.serialization.object({
    ...
    output: SmartGptPageOutput.optional(),
});

export declare namespace SmartGptPageStatusResponse {
    interface Raw {
        run_id: string;
        web_url: string;
        created_at: string;
        ...
        detail: string;
        output?: SmartGptPageOutput.Raw | null;
    }
}
