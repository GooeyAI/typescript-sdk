...
export const RelatedQnADocPageStatusResponse: core.serialization.ObjectSchema<
    serializers.RelatedQnADocPageStatusResponse.Raw,
    Gooey.RelatedQnADocPageStatusResponse
> = core.serialization.object({
    ...
    output: RelatedQnADocPageOutput.optional(),
});

export declare namespace RelatedQnADocPageStatusResponse {
    interface Raw {
        run_id: string;
        web_url: string;
        created_at: string;
        ...
        detail: string;
        output?: RelatedQnADocPageOutput.Raw | null;
    }
}
