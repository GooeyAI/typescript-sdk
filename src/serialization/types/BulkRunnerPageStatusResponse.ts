...
export const BulkRunnerPageStatusResponse: core.serialization.ObjectSchema<
    serializers.BulkRunnerPageStatusResponse.Raw,
    Gooey.BulkRunnerPageStatusResponse
> = core.serialization.object({
    ...
    output: BulkRunnerPageOutput.optional(),
});

export declare namespace BulkRunnerPageStatusResponse {
    interface Raw {
        run_id: string;
        web_url: string;
        created_at: string;
        ...
        detail: string;
        output?: BulkRunnerPageOutput.Raw | null;
    }
}
