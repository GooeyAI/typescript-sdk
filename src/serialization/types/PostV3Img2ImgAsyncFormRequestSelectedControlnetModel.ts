...
import { PostV3Img2ImgAsyncFormRequestSelectedControlnetModelItem } from "./PostV3Img2ImgAsyncFormRequestSelectedControlnetModelItem";

export const PostV3Img2ImgAsyncFormRequestSelectedControlnetModel: core.serialization.Schema<
    serializers.PostV3Img2ImgAsyncFormRequestSelectedControlnetModel.Raw,
    Gooey.PostV3Img2ImgAsyncFormRequestSelectedControlnetModel
> = core.serialization.undiscriminatedUnion([
    core.serialization.list(PostV3Img2ImgAsyncFormRequestSelectedControlnetModelItem),
...
export declare namespace PostV3Img2ImgAsyncFormRequestSelectedControlnetModel {
    type Raw =
        | PostV3Img2ImgAsyncFormRequestSelectedControlnetModelItem.Raw[]
        | "sd_controlnet_canny"
        | "sd_controlnet_depth"
        | "sd_controlnet_hed"
        | "sd_controlnet_mlsd"
