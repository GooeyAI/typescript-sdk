...
export const QrCodeGeneratorPageRequestQrCodeVcard: core.serialization.ObjectSchema<
    serializers.QrCodeGeneratorPageRequestQrCodeVcard.Raw,
    Gooey.QrCodeGeneratorPageRequestQrCodeVcard
...
export declare namespace QrCodeGeneratorPageRequestQrCodeVcard {
    interface Raw {
        format_name: string;
        email?: string | null;
        gender?: string | null;
