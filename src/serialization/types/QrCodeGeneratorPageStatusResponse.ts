...
export const QrCodeGeneratorPageStatusResponse: core.serialization.ObjectSchema<
    serializers.QrCodeGeneratorPageStatusResponse.Raw,
    Gooey.QrCodeGeneratorPageStatusResponse
> = core.serialization.object({
    ...
    output: QrCodeGeneratorPageOutput.optional(),
});

export declare namespace QrCodeGeneratorPageStatusResponse {
    interface Raw {
        run_id: string;
        web_url: string;
        created_at: string;
        ...
        detail: string;
        output?: QrCodeGeneratorPageOutput.Raw | null;
    }
}
