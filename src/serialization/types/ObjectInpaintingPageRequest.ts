...
import { ObjectInpaintingPageRequestFunctionsItem } from "./ObjectInpaintingPageRequestFunctionsItem";
...
> = core.serialization.object({
    functions: core.serialization.list(ObjectInpaintingPageRequestFunctionsItem).optional(),
...
export declare namespace ObjectInpaintingPageRequest {
    interface Raw {
        functions?: ObjectInpaintingPageRequestFunctionsItem.Raw[] | null;
