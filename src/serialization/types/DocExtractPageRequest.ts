...
import { DocExtractPageRequestFunctionsItem } from "./DocExtractPageRequestFunctionsItem";
...
> = core.serialization.object({
    functions: core.serialization.list(DocExtractPageRequestFunctionsItem).optional(),
...
export declare namespace DocExtractPageRequest {
    interface Raw {
        functions?: DocExtractPageRequestFunctionsItem.Raw[] | null;
