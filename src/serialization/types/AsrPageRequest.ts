...
import { AsrPageRequestFunctionsItem } from "./AsrPageRequestFunctionsItem";
...
export const AsrPageRequest: core.serialization.ObjectSchema<serializers.AsrPageRequest.Raw, Gooey.AsrPageRequest> =
    core.serialization.object({
        functions: core.serialization.list(AsrPageRequestFunctionsItem).optional(),
...
export declare namespace AsrPageRequest {
    interface Raw {
        functions?: AsrPageRequestFunctionsItem.Raw[] | null;
