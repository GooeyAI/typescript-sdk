...
export const SeoSummaryPageStatusResponse: core.serialization.ObjectSchema<
    serializers.SeoSummaryPageStatusResponse.Raw,
    Gooey.SeoSummaryPageStatusResponse
> = core.serialization.object({
    ...
    output: SeoSummaryPageOutput.optional(),
});

export declare namespace SeoSummaryPageStatusResponse {
    interface Raw {
        run_id: string;
        web_url: string;
        created_at: string;
        ...
        detail: string;
        output?: SeoSummaryPageOutput.Raw | null;
    }
}
