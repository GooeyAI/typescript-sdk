...
export const QrCodeRequestQrCodeVcard: core.serialization.ObjectSchema<
    serializers.QrCodeRequestQrCodeVcard.Raw,
    Gooey.QrCodeRequestQrCodeVcard
...
export declare namespace QrCodeRequestQrCodeVcard {
    interface Raw {
        format_name: string;
        email?: string | null;
        gender?: string | null;
