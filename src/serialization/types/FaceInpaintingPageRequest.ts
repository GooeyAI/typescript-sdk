...
import { FaceInpaintingPageRequestFunctionsItem } from "./FaceInpaintingPageRequestFunctionsItem";
...
> = core.serialization.object({
    functions: core.serialization.list(FaceInpaintingPageRequestFunctionsItem).optional(),
...
export declare namespace FaceInpaintingPageRequest {
    interface Raw {
        functions?: FaceInpaintingPageRequestFunctionsItem.Raw[] | null;
