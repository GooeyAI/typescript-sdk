...
export const Img2ImgPageStatusResponse: core.serialization.ObjectSchema<
    serializers.Img2ImgPageStatusResponse.Raw,
    Gooey.Img2ImgPageStatusResponse
> = core.serialization.object({
    ...
    output: Img2ImgPageOutput.optional(),
});

export declare namespace Img2ImgPageStatusResponse {
    interface Raw {
        run_id: string;
        web_url: string;
        created_at: string;
        ...
        detail: string;
        output?: Img2ImgPageOutput.Raw | null;
    }
}
