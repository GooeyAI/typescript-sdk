...
import { CreateStreamRequestSelectedModel } from "./CreateStreamRequestSelectedModel";
import { CreateStreamRequestEmbeddingModel } from "./CreateStreamRequestEmbeddingModel";
import { CreateStreamRequestCitationStyle } from "./CreateStreamRequestCitationStyle";
import { CreateStreamRequestAsrModel } from "./CreateStreamRequestAsrModel";
import { CreateStreamRequestTranslationModel } from "./CreateStreamRequestTranslationModel";
import { CreateStreamRequestLipsyncModel } from "./CreateStreamRequestLipsyncModel";
import { LlmTools } from "./LlmTools";
import { CreateStreamRequestResponseFormatType } from "./CreateStreamRequestResponseFormatType";
import { CreateStreamRequestTtsProvider } from "./CreateStreamRequestTtsProvider";
import { CreateStreamRequestOpenaiVoiceName } from "./CreateStreamRequestOpenaiVoiceName";
import { CreateStreamRequestOpenaiTtsModel } from "./CreateStreamRequestOpenaiTtsModel";
import { SadTalkerSettings } from "./SadTalkerSettings";

export const CreateStreamRequest: core.serialization.ObjectSchema<
    serializers.CreateStreamRequest.Raw,
    Gooey.CreateStreamRequest
> = core.serialization.object({
    ...
    userMessageId: core.serialization.property("user_message_id", core.serialization.string().optional()),
    ...
    embeddingModel: core.serialization.property("embedding_model", CreateStreamRequestEmbeddingModel.optional()),
    denseWeight: core.serialization.property("dense_weight", core.serialization.number().optional()),
    citationStyle: core.serialization.property("citation_style", CreateStreamRequestCitationStyle.optional()),
    useUrlShortener: core.serialization.property("use_url_shortener", core.serialization.boolean().optional()),
    asrModel: core.serialization.property("asr_model", CreateStreamRequestAsrModel.optional()),
    asrLanguage: core.serialization.property("asr_language", core.serialization.string().optional()),
    translationModel: core.serialization.property("translation_model", CreateStreamRequestTranslationModel.optional()),
    ...
    openaiVoiceName: core.serialization.property("openai_voice_name", CreateStreamRequestOpenaiVoiceName.optional()),
    openaiTtsModel: core.serialization.property("openai_tts_model", CreateStreamRequestOpenaiTtsModel.optional()),
...
export declare namespace CreateStreamRequest {
    interface Raw {
        ...
        button_pressed?: ButtonPressed.Raw | null;
        ...
        embedding_model?: CreateStreamRequestEmbeddingModel.Raw | null;
        dense_weight?: number | null;
        citation_style?: CreateStreamRequestCitationStyle.Raw | null;
        use_url_shortener?: boolean | null;
        asr_model?: CreateStreamRequestAsrModel.Raw | null;
        asr_language?: string | null;
        translation_model?: CreateStreamRequestTranslationModel.Raw | null;
        ...
        openai_voice_name?: CreateStreamRequestOpenaiVoiceName.Raw | null;
        openai_tts_model?: CreateStreamRequestOpenaiTtsModel.Raw | null;
