...
import { TranslationPageRequestFunctionsItem } from "./TranslationPageRequestFunctionsItem";
...
> = core.serialization.object({
    functions: core.serialization.list(TranslationPageRequestFunctionsItem).optional(),
...
export declare namespace TranslationPageRequest {
    interface Raw {
        functions?: TranslationPageRequestFunctionsItem.Raw[] | null;
