...
export const TranslationPageStatusResponse: core.serialization.ObjectSchema<
    serializers.TranslationPageStatusResponse.Raw,
    Gooey.TranslationPageStatusResponse
> = core.serialization.object({
    ...
    output: TranslationPageOutput.optional(),
});

export declare namespace TranslationPageStatusResponse {
    interface Raw {
        run_id: string;
        web_url: string;
        created_at: string;
        ...
        detail: string;
        output?: TranslationPageOutput.Raw | null;
    }
}
