...
export const GoogleGptPageStatusResponse: core.serialization.ObjectSchema<
    serializers.GoogleGptPageStatusResponse.Raw,
    Gooey.GoogleGptPageStatusResponse
> = core.serialization.object({
    ...
    output: GoogleGptPageOutput.optional(),
});

export declare namespace GoogleGptPageStatusResponse {
    interface Raw {
        run_id: string;
        web_url: string;
        created_at: string;
        ...
        detail: string;
        output?: GoogleGptPageOutput.Raw | null;
    }
}
