...
export const EmbeddingsPageStatusResponse: core.serialization.ObjectSchema<
    serializers.EmbeddingsPageStatusResponse.Raw,
    Gooey.EmbeddingsPageStatusResponse
> = core.serialization.object({
    ...
    output: EmbeddingsPageOutput.optional(),
});

export declare namespace EmbeddingsPageStatusResponse {
    interface Raw {
        run_id: string;
        web_url: string;
        created_at: string;
        ...
        detail: string;
        output?: EmbeddingsPageOutput.Raw | null;
    }
}
