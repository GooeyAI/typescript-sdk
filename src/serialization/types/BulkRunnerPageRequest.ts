...
import { BulkRunnerPageRequestFunctionsItem } from "./BulkRunnerPageRequestFunctionsItem";
...
> = core.serialization.object({
    functions: core.serialization.list(BulkRunnerPageRequestFunctionsItem).optional(),
...
export declare namespace BulkRunnerPageRequest {
    interface Raw {
        functions?: BulkRunnerPageRequestFunctionsItem.Raw[] | null;
