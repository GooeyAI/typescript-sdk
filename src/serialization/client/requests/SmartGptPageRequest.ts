...
import { SmartGptPageRequestFunctionsItem } from "../../types/SmartGptPageRequestFunctionsItem";
...
> = core.serialization.object({
    functions: core.serialization.list(SmartGptPageRequestFunctionsItem).optional(),
...
export declare namespace SmartGptPageRequest {
    interface Raw {
        functions?: SmartGptPageRequestFunctionsItem.Raw[] | null;
